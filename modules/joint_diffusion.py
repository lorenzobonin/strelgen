...
class JointDiffusion(nn.Module):
    ...
    # ... all the get_loss_* functions unchanged ...
    ...
    def sample_opsd(self, 
        ...
        for t in range(self.var_sched.num_steps, 0, -stride):
            ...
            with ctx:
                ...
                g_theta = self.net(deepcopy_preserve_tensors(x_t), beta, data, scene_enc,
    ...
    def sample_opd(self, 
        ...
        # (body unchanged except deepcopy → deepcopy_preserve_tensors
        # and no_grad wrapped with ctx)
